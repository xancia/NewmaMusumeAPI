...
namespace UmaMusumeAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            MariaDbServerVersion serverVersion = new MariaDbServerVersion(
                ServerVersion.AutoDetect(connectionString)
            );

            services.AddDbContextPool<UmaMusumeDbContext>(dbContextOptions =>
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc(
                    ...
                    new OpenApiInfo
                    {
                        ...
                        Version = "v2024.12.08",
                        Description =
                            "A community API for the mobile game, Uma Musume: Pretty Derby. "
                            + "This is utilizing the \"master.mdb\" and \"meta\" files",
                        ...
                        {
                            Name = "API project under Apache 2.0",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            // RapiDoc workaround
            app.MapWhen(
                x => x.Request.Path.StartsWithSegments("/rapidoc"),
                appBuilder =>
                {
