                ...
                await using (var reader = await command.ExecuteReaderAsync())
                {
                    if (await reader.ReadAsync())
                    {
                        return new TerumiCharacterData
                        {
                            ...
                            AptitudeMiddle = reader.IsDBNull(reader.GetOrdinal("AptitudeMiddle"))
                                ? null
                                : GetAptitudeRank(
                                    reader.GetInt32(reader.GetOrdinal("AptitudeMiddle"))
                                ),
                            ...
                            AptitudeRunner = reader.IsDBNull(reader.GetOrdinal("AptitudeRunner"))
                                ? null
                                : GetAptitudeRank(
                                    reader.GetInt32(reader.GetOrdinal("AptitudeRunner"))
                                ),
                            AptitudeLeader = reader.IsDBNull(reader.GetOrdinal("AptitudeLeader"))
                                ? null
                                : GetAptitudeRank(
                                    reader.GetInt32(reader.GetOrdinal("AptitudeLeader"))
                                ),
                            ...
                            AptitudeChaser = reader.IsDBNull(reader.GetOrdinal("AptitudeChaser"))
                                ? null
                                : GetAptitudeRank(
                                    reader.GetInt32(reader.GetOrdinal("AptitudeChaser"))
                                ),
